      ...
      <header className='header-top'>
        <div className='header-top__container'>
          ...
          <form className='header-top__form' action="">
            <input className='header-top__input' type="search" placeholder='Поиск по каталогу' maxLength='100' />
            <button className='header-top__submit' type='submit'>Найти</button>
          </form>
          <a className='header-top__login'>
          ...
          <a className='header-top__favorites'>
          ...
          <a className='header-top__basket'>
